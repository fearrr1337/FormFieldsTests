...
**Ожидаемый результат:** Форма не отправляется. Браузер прокручивает страницу к полю Name, показывает сообщение о необходимости заполнить это поле (например, «Please fill out this field»). Alert с текстом «Message received!» **не появляется**.
